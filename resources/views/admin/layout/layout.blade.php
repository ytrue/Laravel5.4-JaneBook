...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level ">
                        <li>
                            <a class="J_menuItem" href="home/index" data-index="0">首页</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="/admin/users/">用户管理</a>
                        </li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="home/index?v=4.0" frameborder="0" data-id="home/index" seamless></iframe>
        </div>
        <div class="footer">
